...
//            "https://view.publitas.com/p222-11815/coup/page/1",
    public static BoardGame[] boardGameArray = {
            new BoardGame("Werewolf basic - a very basic game",
                    ...
                    new Paragraph[] {
                            new Paragraph(Paragraph.TEXT_TYPE, "Các nhân vật trong trò chơi", "Trò chơi gồm rất nhiều nhân vật, mỗi nhân vật một chức năng khác nhau, hoạt động trong phạm vi khác nhau và với các mục đích cũng khác nhau nốt", null, null),
                            new Paragraph(Paragraph.COMBINE_TYPE_IMAGE_LEFT, "Phù thủy", "Thầy phù thủy quyền năng, đêm đêm thức dậy đóng vai trò bác sĩ và tử thần, nôm na là sẽ được quyền giết và cứu một người 1 đêm duy nhất", "https://raw.githubusercontent.com/cuonghq104/Images/master/Card/witch.png", new String[] {"Phù thủy", "Witch", "Quyền năng", "Chức sắc", "Chức năng"}),
                            new Paragraph(Paragraph.COMBINE_TYPE_IMAGE_RIGHT, "Ma Sói", "Những con ma sói quỷ quyệt, đêm đêm thức dậy nhìn mặt nhau, bắt tay giết chết một người, người là mục tiêu cắn có thể được cứu sống bởi các chức năng khác", "https://raw.githubusercontent.com/cuonghq104/Images/master/Card/WereWolf.jpg", new String[] {"Ma Sói", "Werewolf", "Sói", "Werewolves"})
                    },
